...
export const Sizes = {
  ...
  render: () => (
    <div className="flex flex-col items-start gap-4">
      <ButtonPrimary size="xs">xs</ButtonPrimary>
      <ButtonPrimary size="sm">sm</ButtonPrimary>
      <ButtonPrimary size="md">md</ButtonPrimary>
      <ButtonPrimary size="lg">lg</ButtonPrimary>
    </div>
  ),
} satisfies Story;
...
export const Shapes = {
  ...
  render: () => (
    <div className="flex flex-col items-start gap-4">
      ...
      <ButtonPrimary shape="square" title="Left align">
        <Bars3BottomLeftIcon className="size-6" />
      </ButtonPrimary>
      <ButtonPrimary shape="circle" title="Left align">
        <Bars3BottomLeftIcon className="size-6" />
      </ButtonPrimary>
    </div>
  ),
