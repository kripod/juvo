...
export const Sizes = {
  ...
  render: () => (
    <div className="flex flex-col items-start gap-4">
      <ButtonTertiary size="xs">xs</ButtonTertiary>
      <ButtonTertiary size="sm">sm</ButtonTertiary>
      <ButtonTertiary size="md">md</ButtonTertiary>
      <ButtonTertiary size="lg">lg</ButtonTertiary>
    </div>
  ),
} satisfies Story;
...
export const Shapes = {
  ...
  render: () => (
    <div className="flex flex-col items-start gap-4">
      ...
      <ButtonTertiary shape="square" title="Left align">
        <Bars3BottomLeftIcon className="size-6" />
      </ButtonTertiary>
      <ButtonTertiary shape="circle" title="Left align">
        <Bars3BottomLeftIcon className="size-6" />
      </ButtonTertiary>
    </div>
  ),
